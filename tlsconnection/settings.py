"""
Django settings for tlsconnection project.
...
SECRET_KEY = 'django-insecure-bv2_&814ibi=ab+%2asmz@@=hjxc%3*9od+#n^+1$3&(mwve@8'
...
ROOT_URLCONF = 'tlsconnection.urls'
...
WSGI_APPLICATION = 'tlsconnection.wsgi.application'
